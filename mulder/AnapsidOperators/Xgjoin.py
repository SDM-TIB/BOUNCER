...
from mulder.AnapsidOperators.OperatorStructures import Record, RJTTail, FileDescriptor
...
#        print "----------------END Second Stage!"
    ...
    def flushRJT(self):
        ...
        if tail_to_flush is not None and file_descriptor is not None and resource_to_flush is not None:
